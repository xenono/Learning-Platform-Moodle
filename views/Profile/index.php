...
if ($remarks=='failed') {
echo ' <div id="reg-head-fail" class="headrg">Registration Failed!, Student ID already in use</div> ';
}
if ($remarks=='error') {
...
<tr>
<td class="t-1"><div align="left" id="tb-name">Student ID:</div></td>
...
<table border="0" align="center" cellpadding="2" cellspacing="0">
<tr id="lg-1">
<td class="tl-1"><div align="left" id="tb-name">Student ID:</div></td>
<td><input type="text" id="tb-box" name="username" /></td>
</tr>
<tr id="lg-1">
