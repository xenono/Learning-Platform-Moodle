...
<div id="st"><a href="python.php" id="st-btn1">Python Beginnner</a></div>
<div id="st"><a href="html.php" id="st-btn1">HTML and CSS</a></div>
<div id="st"><a href="C.php" id="st-btn1">C# Beginner</a></div>
...
{  
    ...
    var header = {  
          ...
          slices: {0: {color: '#f98012'}, 1:{color: '#666666'}}
         };  
